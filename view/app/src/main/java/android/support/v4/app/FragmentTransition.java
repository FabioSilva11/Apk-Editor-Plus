...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, BackStackRecord.C0129Op c0129Op, SparseArray sparseArray, boolean z, boolean z2) {
        int i;
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        switch (z ? INVERSE_OPS[c0129Op.cmd] : c0129Op.cmd) {
            case 1:
            case 7:
                z3 = true;
                z4 = false;
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray sparseArray, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            addToFirstInLastOut(backStackRecord, (BackStackRecord.C0129Op) backStackRecord.mOps.get(i), sparseArray, false, z);
        }
    }
    ...
    public static void calculatePopFragments(BackStackRecord backStackRecord, SparseArray sparseArray, boolean z) {
        if (backStackRecord.mManager.mContainer.onHasView()) {
            for (int size = backStackRecord.mOps.size() - 1; size >= 0; size--) {
                addToFirstInLastOut(backStackRecord, (BackStackRecord.C0129Op) backStackRecord.mOps.get(size), sparseArray, true, z);
            }
        }
    }

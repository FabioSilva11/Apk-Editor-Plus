...
public class NotificationCompat {
    ...
    public class Action {
        ...
        public final class WearableExtender implements Extender {
            ...
            public final WearableExtender m3957clone() {
    ...
    public class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0096R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0096R.dimen.compat_notification_large_icon_max_height);
            if (bitmap.getWidth() <= dimensionPixelSize && bitmap.getHeight() <= dimensionPixelSize2) {
                return bitmap;
            }
            double dMin = Math.min(((double) dimensionPixelSize) / ((double) Math.max(1, bitmap.getWidth())), ((double) dimensionPixelSize2) / ((double) Math.max(1, bitmap.getHeight())));
            return Bitmap.createScaledBitmap(bitmap, (int) Math.ceil(((double) bitmap.getWidth()) * dMin), (int) Math.ceil(dMin * ((double) bitmap.getHeight())), true);
        }
    ...
    public class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            boolean z2;
            int iMin;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0096R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0096R.id.actions);
            if (!z || this.mBuilder.mActions == null || (iMin = Math.min(this.mBuilder.mActions.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0096R.id.actions, generateActionButton((Action) this.mBuilder.mActions.get(i)));
                }
                z2 = true;
            }
            int i2 = z2 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(C0096R.id.actions, i2);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0096R.id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0096R.layout.notification_action_tombstone : C0096R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0096R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0096R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0096R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0096R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0096R.id.action_container, action.title);
            }
            return remoteViews;
        }
    ...
    public abstract class Style {
        ...
        private int calculateTopPadding() {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0096R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0096R.dimen.notification_top_pad_large_text);
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0096R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0096R.id.title, 8);
            remoteViews.setViewVisibility(C0096R.id.text2, 8);
            remoteViews.setViewVisibility(C0096R.id.text, 8);
        }
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (z7) {
                    remoteViews.setInt(C0096R.id.notification_background, "setBackgroundResource", C0096R.drawable.notification_bg_low);
                    remoteViews.setInt(C0096R.id.icon, "setBackgroundResource", C0096R.drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0096R.id.notification_background, "setBackgroundResource", C0096R.drawable.notification_bg);
                    remoteViews.setInt(C0096R.id.icon, "setBackgroundResource", C0096R.drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0096R.id.icon, 0);
                    remoteViews.setImageViewBitmap(C0096R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0096R.id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0096R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0096R.dimen.notification_small_icon_background_padding) << 1);
                    if (Build.VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0096R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, this.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0096R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0096R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0096R.id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    remoteViews.setImageViewBitmap(C0096R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0096R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0096R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0096R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0096R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0096R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0096R.id.text, this.mBuilder.mContentText);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0096R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0096R.id.info, 0);
                z4 = true;
                z5 = true;
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0096R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0096R.id.info, resources.getString(C0096R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0096R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0096R.id.info, 0);
                z4 = true;
                z5 = true;
            } else {
                remoteViews.setViewVisibility(C0096R.id.info, 8);
                z4 = z3;
                z5 = z8;
            }
            if (this.mBuilder.mSubText == null || Build.VERSION.SDK_INT < 16) {
                ...
                remoteViews.setTextViewText(C0096R.id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    remoteViews.setTextViewText(C0096R.id.text2, this.mBuilder.mContentText);
                    remoteViews.setViewVisibility(C0096R.id.text2, 0);
                    z6 = true;
                } else {
                    remoteViews.setViewVisibility(C0096R.id.text2, 8);
                    z6 = false;
            ...
            if (z6 && Build.VERSION.SDK_INT >= 16) {
                if (z2) {
                    remoteViews.setTextViewTextSize(C0096R.id.text, 0, resources.getDimensionPixelSize(C0096R.dimen.notification_subtext_size));
                }
                remoteViews.setViewPadding(C0096R.id.line1, 0, 0, 0, 0);
            }
            if (this.mBuilder.getWhenIfShowing() != 0) {
                if (!this.mBuilder.mUseChronometer || Build.VERSION.SDK_INT < 16) {
                    remoteViews.setViewVisibility(C0096R.id.time, 0);
                    remoteViews.setLong(C0096R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                } else {
                    remoteViews.setViewVisibility(C0096R.id.chronometer, 0);
                    remoteViews.setLong(C0096R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    remoteViews.setBoolean(C0096R.id.chronometer, "setStarted", true);
                }
                z5 = true;
            }
            remoteViews.setViewVisibility(C0096R.id.right_side, z5 ? 0 : 8);
            remoteViews.setViewVisibility(C0096R.id.line3, z4 ? 0 : 8);
            return remoteViews;
        }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0096R.id.notification_main_column);
            remoteViews.addView(C0096R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0096R.id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0096R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    public final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (remoteInputs != null) {
                android.app.RemoteInput[] remoteInputArrFromCompat = RemoteInput.fromCompat(remoteInputs);
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public final WearableExtender m3958clone() {
            WearableExtender wearableExtender = new WearableExtender();

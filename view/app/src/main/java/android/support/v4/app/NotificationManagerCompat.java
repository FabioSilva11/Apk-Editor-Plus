...
public final class NotificationManagerCompat {
    ...
    class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f224id, this.tag);
            }
        }
        ...
        public String toString() {
            ...
            sb.append(", id:").append(this.f224id);
    ...
    class NotifyTask implements Task {
        ...
        @Override // android.support.v4.app.NotificationManagerCompat.Task
        public void send(INotificationSideChannel iNotificationSideChannel) {
            iNotificationSideChannel.notify(this.packageName, this.f225id, this.tag, this.notif);
        }

        public String toString() {
            StringBuilder sb = new StringBuilder("NotifyTask[");
            sb.append("packageName:").append(this.packageName);
            sb.append(", id:").append(this.f225id);
            sb.append(", tag:").append(this.tag);
            sb.append("]");
            return sb.toString();
        }

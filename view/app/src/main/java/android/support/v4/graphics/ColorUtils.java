...
public final class ColorUtils {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, m206to = XYZ_WHITE_REFERENCE_Y) double d, @FloatRange(from = -128.0d, m206to = 127.0d) double d2, @FloatRange(from = -128.0d, m206to = 127.0d) double d3) {
        double[] tempDouble3Array = getTempDouble3Array();
        LABToXYZ(d, d2, d3, tempDouble3Array);
        return XYZToColor(tempDouble3Array[0], tempDouble3Array[1], tempDouble3Array[2]);
    }

    public static void LABToXYZ(@FloatRange(from = 0.0d, m206to = XYZ_WHITE_REFERENCE_Y) double d, @FloatRange(from = -128.0d, m206to = 127.0d) double d2, @FloatRange(from = -128.0d, m206to = 127.0d) double d3, @NonNull double[] dArr) {
    ...
    public static void RGBToHSL(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i2, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float fAbs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i2, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i3, @NonNull double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i2, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, m206to = XYZ_WHITE_REFERENCE_X) double d, @FloatRange(from = 0.0d, m206to = XYZ_WHITE_REFERENCE_Y) double d2, @FloatRange(from = 0.0d, m206to = XYZ_WHITE_REFERENCE_Z) double d3) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, m206to = XYZ_WHITE_REFERENCE_X) double d, @FloatRange(from = 0.0d, m206to = XYZ_WHITE_REFERENCE_Y) double d2, @FloatRange(from = 0.0d, m206to = XYZ_WHITE_REFERENCE_Z) double d3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = 0.0d, m206to = 1.0d) float f) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i) * f2) + (Color.alpha(i2) * f)), (int) ((Color.red(i) * f2) + (Color.red(i2) * f)), (int) ((Color.green(i) * f2) + (Color.green(i2) * f)), (int) ((f2 * Color.blue(i)) + (Color.blue(i2) * f)));
    }

    public static void blendHSL(@NonNull float[] fArr, @NonNull float[] fArr2, @FloatRange(from = 0.0d, m206to = 1.0d) float f, @NonNull float[] fArr3) {
        if (fArr3.length != 3) {
    ...
    public static void blendLAB(@NonNull double[] dArr, @NonNull double[] dArr2, @FloatRange(from = 0.0d, m206to = 1.0d) double d, @NonNull double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = MediaDescriptionCompat.BT_FOLDER_TYPE_MIXED, m207to = 255) int i2) {
        if (i2 < 0 || i2 > 255) {

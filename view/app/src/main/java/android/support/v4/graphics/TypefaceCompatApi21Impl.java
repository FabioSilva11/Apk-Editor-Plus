...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    */
    public android.graphics.Typeface createFromFontInfo(android.content.Context r7, android.os.CancellationSignal r8, @android.support.annotation.NonNull android.support.v4.provider.FontsContractCompat.FontInfo[] r9, int r10) throws java.lang.Throwable {
        /*
            r6 = this;
            r0 = 0
            int r1 = r9.length

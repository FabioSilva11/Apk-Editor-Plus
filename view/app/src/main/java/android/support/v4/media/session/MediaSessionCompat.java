        ...
        RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (bundle != null) {
                ...
                if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_RATING)) {
                    metadataEditorBuildRccMetadata.putObject(C0299R.styleable.AppCompatTheme_buttonBarNegativeButtonStyle, (Object) bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_RATING));
                }

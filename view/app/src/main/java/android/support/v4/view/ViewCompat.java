...
public class ViewCompat {
    ...
    class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m210at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0096R.id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0096R.id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
        ...
        private boolean onUnhandledKeyEvent(@NonNull View view, @NonNull KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(C0096R.id.tag_unhandled_key_listeners);
            if (arrayList != null) {
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map arrayMap = (Map) view.getTag(C0096R.id.tag_unhandled_key_listeners);
            if (arrayMap == null) {
                arrayMap = new ArrayMap();
                view.setTag(C0096R.id.tag_unhandled_key_listeners, arrayMap);
            }
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0096R.id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m210at(view).dispatch(view, keyEvent);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m210at(view).preDispatch(keyEvent);
    }
    ...
    public static void removeOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0096R.id.tag_unhandled_key_listeners);
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, m206to = 1.0d) float f) {
        view.setAlpha(f);
    }

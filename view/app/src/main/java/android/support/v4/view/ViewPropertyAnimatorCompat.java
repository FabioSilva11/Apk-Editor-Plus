...
public final class ViewPropertyAnimatorCompat {
    ...
    public final ViewPropertyAnimatorCompat m211x(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    public final ViewPropertyAnimatorCompat m212y(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    public final ViewPropertyAnimatorCompat m213z(float f) {
        View view = (View) this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            view.animate().z(f);
        }

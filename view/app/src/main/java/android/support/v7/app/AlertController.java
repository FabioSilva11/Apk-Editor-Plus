...
class AlertController {
    ...
    public class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                simpleCursorAdapter = this.mCursor == null ? new ArrayAdapter(this.mContext, alertController.mMultiChoiceItemLayout, i, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
    ...
    public class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0299R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0299R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0299R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C0299R.styleable.AlertDialog, C0299R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = typedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = typedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = typedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = typedArrayObtainStyledAttributes.getBoolean(C0299R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0299R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        final View viewFindViewById = this.mWindow.findViewById(C0299R.id.scrollIndicatorUp);
        View viewFindViewById2 = this.mWindow.findViewById(C0299R.id.scrollIndicatorDown);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0299R.id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0299R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0299R.id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0299R.id.alertTitle);
    ...
    private void setupView() {
        ...
        View viewFindViewById3 = this.mWindow.findViewById(C0299R.id.parentPanel);
        View viewFindViewById4 = viewFindViewById3.findViewById(C0299R.id.topPanel);
        View viewFindViewById5 = viewFindViewById3.findViewById(C0299R.id.contentPanel);
        View viewFindViewById6 = viewFindViewById3.findViewById(C0299R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById3.findViewById(C0299R.id.customPanel);
        setupCustomContent(viewGroup);
        View viewFindViewById7 = viewGroup.findViewById(C0299R.id.topPanel);
        View viewFindViewById8 = viewGroup.findViewById(C0299R.id.contentPanel);
        View viewFindViewById9 = viewGroup.findViewById(C0299R.id.buttonPanel);
        ...
        if (!z3 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(C0299R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            View viewFindViewById10 = (this.mMessage == null && this.mListView == null) ? null : viewGroupResolvePanel.findViewById(C0299R.id.titleDividerNoCustom);
            if (viewFindViewById10 != null) {
                viewFindViewById10.setVisibility(0);
            }
        } else if (viewGroupResolvePanel2 != null && (viewFindViewById = viewGroupResolvePanel2.findViewById(C0299R.id.textSpacerNoTitle)) != null) {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0299R.attr.alertDialogCenterButtons, typedValue, true);

...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0299R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0299R.styleable.ActionBar, C0299R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C0299R.styleable.ActionBar_height, 0));

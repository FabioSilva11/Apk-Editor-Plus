...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    static final int[] ATTRS = {C0299R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0299R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0299R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0299R.id.action_bar));
        }
    }

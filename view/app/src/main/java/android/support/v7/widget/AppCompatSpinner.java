...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0299R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0299R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i, int i2, Resources.Theme theme) throws Throwable {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0299R.styleable.Spinner, i, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (theme != null) {
            contextThemeWrapper = new ContextThemeWrapper(context, theme);
            typedArray = this;
        } else {
            int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.Spinner_popupTheme, 0);
            if (resourceId != 0) {
        ...
        typedArray.mPopupContext = contextThemeWrapper;
        if (this.mPopupContext != null) {
            try {
                ...
                if (i2 == 1) {
                    ...
                    TintTypedArray tintTypedArrayObtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, C0299R.styleable.Spinner, i, 0);
                    this.mDropDownWidth = tintTypedArrayObtainStyledAttributes2.getLayoutDimension(C0299R.styleable.Spinner_android_dropDownWidth, -2);
                    dropdownPopup.setBackgroundDrawable(tintTypedArrayObtainStyledAttributes2.getDrawable(C0299R.styleable.Spinner_android_popupBackground));
                    dropdownPopup.setPromptText(tintTypedArrayObtainStyledAttributes.getString(C0299R.styleable.Spinner_android_prompt));
        ...
        CharSequence[] textArray = tintTypedArrayObtainStyledAttributes.getTextArray(C0299R.styleable.Spinner_android_entries);
        if (textArray != null) {
            ArrayAdapter arrayAdapter = new ArrayAdapter(context, R.layout.simple_spinner_item, textArray);
            arrayAdapter.setDropDownViewResource(C0299R.layout.support_simple_spinner_dropdown_item);

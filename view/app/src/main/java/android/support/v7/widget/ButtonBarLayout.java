...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0299R.styleable.ButtonBarLayout);
        this.mAllowStacking = typedArrayObtainStyledAttributes.getBoolean(C0299R.styleable.ButtonBarLayout_allowStacking, true);
    ...
    private void setStacked(boolean z) {
        ...
        setGravity(z ? 5 : 80);
        View viewFindViewById = findViewById(C0299R.id.spacer);

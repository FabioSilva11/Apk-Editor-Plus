...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0299R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0299R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0299R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(tintTypedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.SearchView_layout, C0299R.layout.abc_search_view), (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0299R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0299R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0299R.id.search_plate);
        this.mSubmitArea = findViewById(C0299R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0299R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0299R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0299R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0299R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0299R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0299R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = tintTypedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.SearchView_suggestionRowLayout, C0299R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = tintTypedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(tintTypedArrayObtainStyledAttributes.getBoolean(C0299R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0299R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = tintTypedArrayObtainStyledAttributes.getText(C0299R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = tintTypedArrayObtainStyledAttributes.getText(C0299R.styleable.SearchView_queryHint);
        int i2 = tintTypedArrayObtainStyledAttributes.getInt(C0299R.styleable.SearchView_android_imeOptions, -1);
        if (i2 != -1) {
            setImeOptions(i2);
        }
        int i3 = tintTypedArrayObtainStyledAttributes.getInt(C0299R.styleable.SearchView_android_inputType, -1);
        if (i3 != -1) {
            setInputType(i3);
        }
        setFocusable(tintTypedArrayObtainStyledAttributes.getBoolean(C0299R.styleable.SearchView_android_focusable, true));
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0299R.dimen.abc_search_view_preferred_height);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0299R.dimen.abc_search_view_preferred_width);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0299R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0299R.dimen.abc_dropdownitem_icon_width) : 0;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        switch (mode) {
            case Integer.MIN_VALUE:
                size = this.mMaxWidth <= 0 ? Math.min(getPreferredWidth(), size) : Math.min(this.mMaxWidth, size);
                break;
            case 0:
                size = this.mMaxWidth <= 0 ? getPreferredWidth() : this.mMaxWidth;
                break;
            case 1073741824:
                if (this.mMaxWidth > 0) {

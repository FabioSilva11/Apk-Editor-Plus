...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0299R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0299R.attr.textColorSearchUrl, typedValue, true);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) viewNewView.findViewById(C0299R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }

...
public class SwitchCompat extends CompoundButton {
    ...
    private static final Property THUMB_POS = new Property(Float.class, "thumbPos") { // from class: android.support.v7.widget.SwitchCompat.1
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0299R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0299R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = tintTypedArrayObtainStyledAttributes.getDrawable(C0299R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = tintTypedArrayObtainStyledAttributes.getText(C0299R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = tintTypedArrayObtainStyledAttributes.getText(C0299R.styleable.SwitchCompat_android_textOff);
        this.mShowText = tintTypedArrayObtainStyledAttributes.getBoolean(C0299R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0299R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0299R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0299R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = tintTypedArrayObtainStyledAttributes.getBoolean(C0299R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(C0299R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(C0299R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList colorStateList2 = tintTypedArrayObtainStyledAttributes.getColorStateList(C0299R.styleable.SwitchCompat_trackTint);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode tintMode2 = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(C0299R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(C0299R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        switch (getGravity() & C0299R.styleable.AppCompatTheme_ratingBarStyleSmall) {
            case 16:
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(C0299R.styleable.TextAppearance_android_textColor);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(C0299R.styleable.TextAppearance_android_textSize, 0);
        if (dimensionPixelSize != 0 && dimensionPixelSize != this.mTextPaint.getTextSize()) {
            this.mTextPaint.setTextSize(dimensionPixelSize);
            requestLayout();
        }
        setSwitchTypefaceByIndex(tintTypedArrayObtainStyledAttributes.getInt(C0299R.styleable.TextAppearance_android_typeface, -1), tintTypedArrayObtainStyledAttributes.getInt(C0299R.styleable.TextAppearance_android_textStyle, -1));
        if (tintTypedArrayObtainStyledAttributes.getBoolean(C0299R.styleable.TextAppearance_textAllCaps, false)) {

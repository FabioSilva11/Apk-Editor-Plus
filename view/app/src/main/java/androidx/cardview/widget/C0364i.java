...
/* JADX INFO: renamed from: androidx.cardview.widget.i */
/* JADX INFO: loaded from: classes.dex */
class C0364i extends Drawable {
    ...
    C0364i(ColorStateList colorStateList, float f) {
        this.mRadius = f;
    ...
    private void updateBounds(Rect rect) {
        ...
        if (this.mInsetForPadding) {
            this.mBoundsI.inset((int) Math.ceil(C0365j.calculateHorizontalPadding(this.mPadding, this.mRadius, this.mInsetForRadius)), (int) Math.ceil(C0365j.calculateVerticalPadding(this.mPadding, this.mRadius, this.mInsetForRadius)));

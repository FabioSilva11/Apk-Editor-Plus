...
/* JADX INFO: renamed from: androidx.cardview.widget.j */
/* JADX INFO: loaded from: classes.dex */
class C0365j extends Drawable {
    private static final double COS_45 = Math.cos(Math.toRadians(45.0d));
    private static final float SHADOW_MULTIPLIER = 1.5f;
    static InterfaceC0366k sRoundRectHelper;
    ...
    C0365j(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0369n.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0369n.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0370o.cardview_compat_inset_shadow);

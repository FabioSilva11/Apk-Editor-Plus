...
public final class SignatureAlgorithm {
    ...
    static {
        ...
        SignatureAlgorithm signatureAlgorithm = new SignatureAlgorithm("RSA_PSS_WITH_SHA256", 0, InputDeviceCompat.SOURCE_KEYBOARD, contentDigestAlgorithm, "RSA", Pair.m2038of("SHA256withRSA/PSS", new PSSParameterSpec("SHA-256", "MGF1", MGF1ParameterSpec.SHA256, 32, 1)), 24, 23);
        ...
        SignatureAlgorithm signatureAlgorithm2 = new SignatureAlgorithm("RSA_PSS_WITH_SHA512", 1, 258, contentDigestAlgorithm2, "RSA", Pair.m2038of("SHA512withRSA/PSS", new PSSParameterSpec("SHA-512", "MGF1", MGF1ParameterSpec.SHA512, 64, 1)), 24, 23);
        RSA_PSS_WITH_SHA512 = signatureAlgorithm2;
        SignatureAlgorithm signatureAlgorithm3 = new SignatureAlgorithm("RSA_PKCS1_V1_5_WITH_SHA256", 2, 259, contentDigestAlgorithm, "RSA", Pair.m2038of("SHA256withRSA", null), 24, 1);
        RSA_PKCS1_V1_5_WITH_SHA256 = signatureAlgorithm3;
        SignatureAlgorithm signatureAlgorithm4 = new SignatureAlgorithm("RSA_PKCS1_V1_5_WITH_SHA512", 3, 260, contentDigestAlgorithm2, "RSA", Pair.m2038of("SHA512withRSA", null), 24, 1);
        RSA_PKCS1_V1_5_WITH_SHA512 = signatureAlgorithm4;
        SignatureAlgorithm signatureAlgorithm5 = new SignatureAlgorithm("ECDSA_WITH_SHA256", 4, InputDeviceCompat.SOURCE_DPAD, contentDigestAlgorithm, "EC", Pair.m2038of("SHA256withECDSA", null), 24, 11);
        ECDSA_WITH_SHA256 = signatureAlgorithm5;
        SignatureAlgorithm signatureAlgorithm6 = new SignatureAlgorithm("ECDSA_WITH_SHA512", 5, 514, contentDigestAlgorithm2, "EC", Pair.m2038of("SHA512withECDSA", null), 24, 11);
        ECDSA_WITH_SHA512 = signatureAlgorithm6;
        SignatureAlgorithm signatureAlgorithm7 = new SignatureAlgorithm("DSA_WITH_SHA256", 6, 769, contentDigestAlgorithm, "DSA", Pair.m2038of("SHA256withDSA", null), 24, 1);
        ...
        SignatureAlgorithm signatureAlgorithm8 = new SignatureAlgorithm("VERITY_RSA_PKCS1_V1_5_WITH_SHA256", 7, 1057, contentDigestAlgorithm3, "RSA", Pair.m2038of("SHA256withRSA", null), 28, 1);
        VERITY_RSA_PKCS1_V1_5_WITH_SHA256 = signatureAlgorithm8;
        SignatureAlgorithm signatureAlgorithm9 = new SignatureAlgorithm("VERITY_ECDSA_WITH_SHA256", 8, 1059, contentDigestAlgorithm3, "EC", Pair.m2038of("SHA256withECDSA", null), 28, 11);
        VERITY_ECDSA_WITH_SHA256 = signatureAlgorithm9;
        SignatureAlgorithm signatureAlgorithm10 = new SignatureAlgorithm("VERITY_DSA_WITH_SHA256", 9, 1061, contentDigestAlgorithm3, "DSA", Pair.m2038of("SHA256withDSA", null), 28, 1);

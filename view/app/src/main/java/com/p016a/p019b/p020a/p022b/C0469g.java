...
public final class C0469g {
    ...
    private static final int[] f550a = new int[256];

    /* JADX INFO: renamed from: b */
    private static final String[] f551b = new String[256];
    ...
    /* JADX INFO: renamed from: a */
    public static String m575a(int i) {
        String str = f551b[i];
        if (str != null) {
            return str;
        }
        String str2 = "unused_" + C0985a.m2298x(i);
        f551b[i] = str2;
        return str2;
    }

    /* JADX INFO: renamed from: b */
    public static int m576b(int i) {
        return f550a[i];
    }
}

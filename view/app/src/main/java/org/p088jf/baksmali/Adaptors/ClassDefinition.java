...
import org.p088jf.baksmali.formatter.BaksmaliFormatter;
import org.p088jf.baksmali.formatter.BaksmaliWriter;
import org.p088jf.dexlib2.AccessFlags;
import org.p088jf.dexlib2.Opcode;
import org.p088jf.dexlib2.dexbacked.DexBackedClassDef;
        ...
        for (Method method : classDef.getDirectMethods()) {
            if (method.getName().equals("<clinit>") && (implementation = method.getImplementation()) != null) {
                for (Instruction instruction : implementation.getInstructions()) {
                    switch (C16781.$SwitchMap$org$jf$dexlib2$Opcode[instruction.getOpcode().ordinal()]) {
                        case 1:
                        case 2:
                        case 3:
                        case 4:
